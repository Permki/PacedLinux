 ...
 */
NFP_API
ssize_t nfp_sram_read(struct nfp_device *dev,
		      void *buffer,
 ...
 */
NFP_API
ssize_t nfp_sram_write(struct nfp_device *dev,
		       const void *buffer,
		       unsigned long long length,
		       unsigned long long offset);
 ...
 */
NFP_API
ssize_t nfp_sram_fill(struct nfp_device *dev,
		      const void *buffer,
 ...
 */
NFP_API
ssize_t nfp_emem_read(struct nfp_device *dev,
		      int islnum,
		      void *buffer,
		      unsigned long long length,
		      unsigned long long offset);
 ...
 */
NFP_API
ssize_t nfp_emem_write(struct nfp_device *dev,
		       int islnum,
		       const void *buffer,
		       unsigned long long length,
		       unsigned long long offset);
 ...
 */
NFP_API
ssize_t nfp_emem_fill(struct nfp_device *dev,
		      int islnum,
		      const void *buffer,
		      unsigned long long buf_length,
		      unsigned long long offset,
 ...
 */
NFP_API
ssize_t nfp_emem64_read(struct nfp_device *dev,
			int islnum,
			void *buffer,
			unsigned long long length,
			unsigned long long offset);
 ...
 */
NFP_API
ssize_t nfp_emem64_write(struct nfp_device *dev,
			 int islnum,
			 const void *buffer,
			 unsigned long long length,
			 unsigned long long offset);
 ...
 */
NFP_API
ssize_t nfp_emem64_fill(struct nfp_device *dev,
			int islnum,
			const void *buffer,
			unsigned long long buf_length,
			unsigned long long offset,
 ...
 */
NFP_API
ssize_t nfp_imem_read(struct nfp_device *dev,
		      int islnum,
		      void *buffer,
		      unsigned long long length,
		      unsigned long long offset);
 ...
 */
NFP_API
ssize_t nfp_imem_write(struct nfp_device *dev,
		       int islnum,
		       const void *buffer,
		       unsigned long long length,
		       unsigned long long offset);
 ...
 */
NFP_API
ssize_t nfp_imem_fill(struct nfp_device *dev,
		      int islnum,
		      const void *buffer,
		      unsigned long long buf_length,
		      unsigned long long offset,
 ...
 */
NFP_API
ssize_t nfp_ctm_read(struct nfp_device *dev,
		     int islnum,
		     void *buffer,
		     unsigned long long length,
		     unsigned long long offset);
 ...
 */
NFP_API
ssize_t nfp_ctm_write(struct nfp_device *dev,
		      int islnum,
		      const void *buffer,
		      unsigned long long length,
		      unsigned long long offset);
 ...
 */
NFP_API
ssize_t nfp_ctm_fill(struct nfp_device *dev,
		     int islnum,
		     const void *buffer,
		     unsigned long long buf_length,
		     unsigned long long offset,
 ...
 */
NFP_API
ssize_t nfp_cls_read(struct nfp_device *dev,
		     int clnum,
		     void *buffer,
		     unsigned long long length,
		     unsigned long long offset);
 ...
 */
NFP_API
ssize_t nfp_cls_write(struct nfp_device *dev,
		      int clnum,
		      const void *buffer,
		      unsigned long long length,
		      unsigned long long offset);
 ...
 */
NFP_API
ssize_t nfp_cls_fill(struct nfp_device *dev,
		     int clnum,
		     const void *buffer,
		     unsigned long long buf_length,
		     unsigned long long offset,
 ...
 */
NFP_API
ssize_t nfp_lmem_read(struct nfp_device *dev,
		      int meid,
		      void *buffer,
		      unsigned long long length,
		      unsigned long long offset);
 ...
 */
NFP_API
ssize_t nfp_lmem_write(struct nfp_device *dev,
		       int meid,
		       const void *buffer,
		       unsigned long long length,
		       unsigned long long offset);
 ...
 */
NFP_API
ssize_t nfp_lmem_fill(struct nfp_device *dev,
		      int meid,
		      const void *buffer,
		      unsigned long long buf_length,
		      unsigned long long offset,
 ...
 */
NFP_API
ssize_t nfp_ustore_read(struct nfp_device *dev,
			int meid,
			void *buffer,
			unsigned long long length,
			unsigned long long offset);
 ...
 */
NFP_API
ssize_t nfp_ustore_write(struct nfp_device *dev,
			 int meid,
			 const void *buffer,
			 unsigned long long length,
			 unsigned long long offset);
 ...
 */
NFP_API
ssize_t nfp_ustore_fill(struct nfp_device *dev,
			int meid,
			const void *buffer,
			unsigned long long buf_length,
			unsigned long long offset,
 ...
 */
NFP_API
ssize_t nfp_crypto_sram_read(struct nfp_device *dev,
			     int islnum,
			     void *buffer,
			     unsigned long long length,
			     unsigned long long offset);
 ...
 */
NFP_API
ssize_t nfp_crypto_sram_write(struct nfp_device *dev,
			      int islnum,
			      const void *buffer,
			      unsigned long long length,
			      unsigned long long offset);
 ...
 */
NFP_API
ssize_t nfp_crypto_sram_fill(struct nfp_device *dev,
			     int islnum,
			     const void *buffer,
			     unsigned long long buf_length,
			     unsigned long long offset,
 ...
 */
NFP_API
int nfp_mecsr_read(struct nfp_device *dev,
		   int meid,
		   int ctx,
		   unsigned int csr,
		   uint32_t *value);
 ...
 */
NFP_API
int nfp_mecsr_write(struct nfp_device *dev,
		    int meid,
		    int ctx,
		    unsigned int csr,
		    uint32_t value);
 ...
 */
NFP_API
int nfp_me_register_read(struct nfp_device *dev,
			 int meid,
			 unsigned int reg,
			 uint32_t *value);
 ...
 */
NFP_API
int nfp_me_register_write(struct nfp_device *dev,
			  int meid,
			  unsigned int reg,
			  uint32_t value);
 ...
 */
NFP_API
int nfp_temp(struct nfp_device *dev,
	     uint32_t *raw_value,
	     float *temp_c,
	     float *temp_err);
 ...
 */
NFP_API
int nfp_mdio_cl22_write(struct nfp_device *dev,
			int bus,
			uint8_t addr,
			uint8_t reg,
			uint16_t data);
 ...
 */
NFP_API
int nfp_mdio_cl22_read(struct nfp_device *dev,
		       int bus,
		       uint8_t addr,
		       uint8_t reg,
		       uint16_t *data);
 ...
 */
NFP_API
int nfp_mdio_cl45_write(struct nfp_device *dev,
			int bus,
			uint8_t addr,
			uint8_t subdev,
			uint16_t reg,
 ...
 */
NFP_API
int nfp_mdio_cl45_read(struct nfp_device *dev,
		       int bus,
		       uint8_t addr,
		       uint8_t subdev,
		       uint16_t reg,
 ...
 */
NFP_API
struct nfp_mdio *nfp_mdio_bus_open(struct nfp_device *dev,
				   int bus);
 ...
 */
NFP_API
int nfp_mdio45_transact(struct nfp_mdio *mdio,
			int hz,
			int pream_len,
			int phy,
			int dev,
 ...
 */
NFP_API
int nfp_mdio45_locked_transact(struct nfp_mdio *mdio,
			       int hz,
			       int pream_len,
			       int phy,
			       int dev,
 ...
 */
NFP_API
int nfp_err_open(unsigned int devnum,
		 int flags);
