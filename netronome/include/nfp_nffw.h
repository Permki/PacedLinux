 ...
 */
NFP_NFFW_API
int nfp_nffw_load(struct nfp_device *nfp,
		  const void *data,
		  size_t size,
		  uint8_t *fwid);
 ...
 */
NFP_NFFW_API
int nfp_nffw_load_mutable(struct nfp_device *nfp,
			  void *data,
			  size_t size,
			  uint8_t *fwid);
 ...
 */
NFP_NFFW_API
int nfp_nffw_start(struct nfp_device *nfp,
		   uint8_t fwid);
 ...
 */
NFP_NFFW_API
int nfp_nffw_unload(struct nfp_device *nfp,
		    uint8_t fwid);
 ...
 */
NFP_NFFW_API
const struct nfp_rtsym *nfp_rtsym_get(struct nfp_device *nfp,
				      int idx);
 ...
 */
NFP_NFFW_API
ssize_t nfp_rtsym_read(struct nfp_device *nfp,
 ...
 */
NFP_NFFW_API
ssize_t nfp_rtsym_write(struct nfp_device *nfp,
			const struct nfp_rtsym *symbol,
			const void *buffer,
			size_t buf_length,
			unsigned long long offset);
 ...
 */
NFP_NFFW_API
ssize_t nfp_rtsym_fill(struct nfp_device *nfp,
		       const struct nfp_rtsym *symbol,
		       const void *buffer,
		       size_t buf_length,
		       unsigned long long offset,
 ...
 */
NFP_NFFW_API
int nfp_nffw_info_fw_loaded_set(struct nfp_device *nfp,
				int is_loaded);
 ...
 */
NFP_NFFW_API
int nfp_nffw_info_fw_modular_set(struct nfp_device *nfp,
				 int is_modular);
 ...
 */
NFP_NFFW_API
uint8_t nfp_nffw_info_me_ctxmask(struct nfp_device *nfp,
				 int meid);
 ...
 */
NFP_NFFW_API
int nfp_nffw_info_me_ctxmask_set(struct nfp_device *nfp,
				 int meid,
				 uint8_t ctxmask);
 ...
 */
NFP_NFFW_API
uint8_t nfp_nffw_info_me_fwid(struct nfp_device *nfp,
			      int meid);
 ...
 */
NFP_NFFW_API
int nfp_nffw_info_me_fwid_set(struct nfp_device *nfp,
			      int meid,
			      uint8_t fwid);
 ...
 */
NFP_NFFW_API
int nfp_nffw_info_fwid_free(struct nfp_device *nfp,
			    uint8_t fwid);
 ...
 */
NFP_NFFW_API
uint8_t nfp_nffw_info_fwid_next(struct nfp_device *nfp,
				uint8_t fwid);
 ...
 */
NFP_NFFW_API
int nfp_nffw_info_fw_mip(struct nfp_device *nfp,
			 uint8_t fwid,
			 uint32_t *cpp_id,
			 uint64_t *off);
 ...
 */
NFP_NFFW_API
int nfp_nffw_info_fw_mip_set(struct nfp_device *nfp,
			     uint8_t fwid,
			     uint32_t cpp_id,
			     uint64_t off);
