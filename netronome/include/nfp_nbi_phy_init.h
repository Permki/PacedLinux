...
int sequence_ate_lb_buf_10p3125gbs_156p25_adapt_100ohm(
	struct nfp_serdes *serdes, int group,
...
int sequence_ate_lb_buf_12p5gbs_156p25m_adapt_100ohm(
	struct nfp_serdes *serdes, int group,
	struct TXIODRIVER_params txiodriver[4],
	struct CMNREFCKBUF_TERM_100OHM_params cmnrefckbuf_term_100ohm,
	struct RXEQ_params rxeq[4]);
...
int sequence_ate_lb_buf_1p25gbs_156p25m_adapt_100ohm(
	struct nfp_serdes *serdes, int group,
	struct TXIODRIVER_params txiodriver[4],
	struct CMNREFCKBUF_TERM_100OHM_params cmnrefckbuf_term_100ohm,
	struct RXEQ_params rxeq[4]);
...
int sequence_ate_lb_ext_1p25gbs_156p25M_100ohm(
	struct nfp_serdes *serdes, int group,
	struct TXIODRIVER_params txiodriver[4],
	struct CMNREFCKBUF_TERM_100OHM_params cmnrefckbuf_term_100ohm,
	struct RXEQ_params rxeq[4]);
...
int sequence_ate_lb_ext_10p3125gbs_156p25_adapt_100ohm(
	struct nfp_serdes *serdes, int group,
	struct TXIODRIVER_params txiodriver[4],
	struct CMNREFCKBUF_TERM_100OHM_params cmnrefckbuf_term_100ohm,
	struct RXEQ_params rxeq[4]);
...
// description: Initialize phy at 10.3125gbps with external loopback
int sequence_ate_lb_ext_12p5gbs_156p25m_adapt_100ohm(
	struct nfp_serdes *serdes, int group,
	struct TXIODRIVER_params txiodriver[4],
	struct CMNREFCKBUF_TERM_100OHM_params cmnrefckbuf_term_100ohm,
	struct RXEQ_params rxeq[4]);
...
int sequence_rxadapt(struct nfp_serdes *serdes,
		     int group,
		     struct RXEQ_params rxeq[4]);
 ...
 */
int nfp_nbi_phy_serdes_init(
	struct nfp_serdes *serdes,
...
/*
 * Re-Initialize Serdes Lane
 * @ingroup nfp6000-only
 *
 * Re-Initialize the serdes lane.
 * Assumes serdes previously initialized
 *
 * @param serdes Serdes handle
 * @param params Parameter struct (see  nfp_nbi_phy_params)
 * @param txiodriver Tx lane tuning values
 * @param rxeq Rx lane tuning values
 */
int nfp_nbi_phy_lane_setstatic(struct nfp_serdes *serdes,
			       struct nfp_nbi_phy_params *params,
			       struct TXIODRIVER_params txiodriver,
			       struct RXEQ_params rxeq);
