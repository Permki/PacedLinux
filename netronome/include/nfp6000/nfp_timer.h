...
#define   NFP_TIMER_TIMERCONTROL_ACTIVE                      BIT(7)
...
#define   NFP_TIMER_TIMERCOUNTERCLEAR_CLRINT                 BIT(0)
#define     NFP_TIMER_TIMERCOUNTERCLEAR_CLRINT_NOOP          (0 << 0)
#define     NFP_TIMER_TIMERCOUNTERCLEAR_CLRINT_CI            BIT(0)
/*----------------------------------------------------------------
...
#define   NFP_TIMER_WATCHDOGENABLE_WDOGEN                    BIT(0)
#define     NFP_TIMER_WATCHDOGENABLE_WDOGEN_NOOP             (0 << 0)
#define     NFP_TIMER_WATCHDOGENABLE_WDOGEN_CI               BIT(0)
