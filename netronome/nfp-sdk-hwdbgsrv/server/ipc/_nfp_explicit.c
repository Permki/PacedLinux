...
static void __nfp_explicit_rpc_version(ns_ipc_server_conn_handle_t con,
                              ns_ipc_buf_t *b_out,
                              ns_ipc_buf_t *b_in)
{
...
struct ipc_server_fmap ipc_nfp_explicit_fmaps[] = {
        {"nfp_explicit_rpc_version", __nfp_explicit_rpc_version},
        {NULL, NULL}};
