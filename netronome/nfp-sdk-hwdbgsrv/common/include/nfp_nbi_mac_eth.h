 ...
 */
NFP_NBI_API
int nfp_nbi_mac_eth_read_ingress_dsa(struct nfp_nbi_dev *nbi, int core, int port);
 ...
 */
NFP_NBI_API
int nfp_nbi_mac_eth_write_egress_skip(struct nfp_nbi_dev *nbi, int core, int port,
                                  int octets);
 ...
 */
NFP_NBI_API
int nfp_nbi_mac_eth_read_egress_skip(struct nfp_nbi_dev *nbi, int core, int port);
 ...
 */
NFP_NBI_API
int nfp_nbi_mac_eth_write_ingress_prepend_enable(struct nfp_nbi_dev *nbi, int core,
 ...
 */
NFP_NBI_API
int nfp_nbi_mac_eth_read_ingress_prepend_enable(struct nfp_nbi_dev *nbi, int core,
                                            int port);
 ...
 */
NFP_NBI_API
int nfp_nbi_mac_eth_write_ingress_skip(struct nfp_nbi_dev *nbi, int core, int port,
                                   int octets);
 ...
 */
NFP_NBI_API
int nfp_nbi_mac_eth_read_ingress_skip(struct nfp_nbi_dev *nbi, int core, int port);
 ...
 */
NFP_NBI_API
int nfp_nbi_mac_eth_write_loopback_mode(struct nfp_nbi_dev *nbi, int core, int port,
                                        int mode);
 ...
 */
NFP_NBI_API
int nfp_nbi_mac_eth_read_loopback_mode(struct nfp_nbi_dev *nbi, int core, int port);
 ...
 */
NFP_NBI_API
int nfp_nbi_mac_eth_write_pause_quant(struct nfp_nbi_dev *nbi, int core, int port,
 ...
 */
NFP_NBI_API
int nfp_nbi_mac_eth_read_pause_quant(struct nfp_nbi_dev *nbi, int core, int port,
                                 int pcpclass);
 ...
 */
NFP_NBI_API
int nfp_nbi_mac_eth_write_pause_thresh(struct nfp_nbi_dev *nbi, int core, int port,
 ...
 */
NFP_NBI_API
int nfp_nbi_mac_eth_read_pause_thresh(struct nfp_nbi_dev *nbi, int core, int port,
                                  int pcpclass);
 ...
 */
NFP_NBI_API
int nfp_nbi_mac_eth_read_pause_status(struct nfp_nbi_dev *nbi, int core, int port);
 ...
 */
NFP_NBI_API
int nfp_nbi_mac_write_timestamp(struct nfp_nbi_dev *nbi, uint64_t ts_sec, uint64_t ts_nsec);
 ...
 */
NFP_NBI_API
int nfp_nbi_mac_read_timestamp(struct nfp_nbi_dev *nbi, uint64_t *ts_sec, uint64_t *ts_nsec);
 ...
 */
NFP_NBI_API
int nfp_nbi_mac_eth_write_resets(struct nfp_nbi_dev *nbi, int core, uint32_t mask);
 ...
 */
NFP_NBI_API
int nfp_nbi_mac_eth_write_vlantpid(struct nfp_nbi_dev *nbi, int slot, int vlanid);
...
/**
 * Calculate the mode for each TDM slot based on port speed.
 * @ingroup nfp6000-only
 *
 * Each Ethernet core uses a 12-slot TDM wheel to pass packet data to
 * the NBI gasket interface.  This function calculates the mode
 * setting for a given segment based on the settings for each port the
 * in the configuration structure. This function is only used during
 * MAC initialization.
 *
 * @param mcfg MAC configuration struct
 * @param seg  core segment [0-11]
 *
 * @return 0 on success. Set errno and return -1 on error.
 */
NFP_NBI_API
int nfp_nbi_mac_calc_tdm_mode(struct nfp_nbi_mac_config *mcfg, int seg);
 ...
 * @param core MAC ethernet core: [0-1]
 * @param port MAC ethernet port: [0-11]
 * @param mask Mask of bits to set/clear
 * @param value cmdconfig settings for above parameters
 *
 * @return 0 on success. Set errno and return -1 on error.
 */
NFP_NBI_API
int nfp_nbi_mac_eth_write_cmdconfig(struct nfp_nbi_dev *nbi, int core, int port,
