 ...
 */
NFP_NBI_API
int nfp_nbi_mac_ilk_write_resets(struct nfp_nbi_dev *nbi, int core, uint32_t mask);
 ...
 */
NFP_NBI_API
int nfp_nbi_mac_ilk_read_linkstate(struct nfp_nbi_dev *nbi, int core,
                                   uint32_t *linkstate);
 ...
 */
NFP_NBI_API
int nfp_nbi_mac_ilk_write_lane_disable(struct nfp_nbi_dev *nbi, int core,
                                       uint32_t mask);
 ...
 */
NFP_NBI_API
int nfp_nbi_mac_ilk_write_egress_skip(struct nfp_nbi_dev *nbi, int core,
                                      int octets);
 ...
 */
NFP_NBI_API
int nfp_nbi_mac_ilk_write_ingress_skip(struct nfp_nbi_dev *nbi, int core,
                                       int octets);
 ...
 */
NFP_NBI_API
int nfp_nbi_mac_ilk_write_ingress_dsa(struct nfp_nbi_dev *nbi, int core,
                                      int octets);
 ...
 */
NFP_NBI_API
int nfp_nbi_mac_ilk_write_egress_dsa(struct nfp_nbi_dev *nbi, int core, int octets);
 ...
 */
NFP_NBI_API
int nfp_nbi_mac_ilk_write_burst_limits(struct nfp_nbi_dev nbi, int core,
 ...
 */
NFP_NBI_API
int nfp_nbi_mac_ilk_write_metaframe(struct nfp_nbi_dev nbi, int core, int period);
 ...
 */
NFP_NBI_API
int nfp_nbi_mac_ilk_write_calendar(struct nfp_nbi_dev nbi, int core,
 ...
 */
NFP_NBI_API
int nfp_nbi_mac_ilk_oobfc_ena(struct nfp_nbi_dev nbi, int core, uint32_t enables);
 ...
 */
NFP_NBI_API
int nfp_nbi_mac_ilk_write_ingress_dqdwrr(struct nfp_nbi_dev *nbi, int core,
                                         int en, int weight);
 ...
 */
NFP_NBI_API
int nfp_nbi_mac_ilk_write_port_hwm(struct nfp_nbi_dev *nbi, int core, int hwm, int delta);
 ...
 */
NFP_NBI_API
int nfp_nbi_mac_ilk_write_loopback_mode(struct nfp_nbi_dev *nbi, int core,
                                        uint32_t mode);
