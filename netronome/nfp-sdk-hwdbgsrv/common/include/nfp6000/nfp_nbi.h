...
#define   NFP_NBIX_CSR_NBI_STAT_NBI_XPB_MSTR_TIMEOUT_ERR_E   BIT(28)
#define   NFP_NBIX_CSR_NBI_STAT_NBI_PUSHPULL_P7B_ERR_E       BIT(27)
#define   NFP_NBIX_CSR_NBI_STAT_NBI_PUSHPULL_P7A_ERR_E       BIT(26)
#define   NFP_NBIX_CSR_NBI_STAT_NBI_PUSHPULL_P6B_ERR_E       BIT(25)
#define   NFP_NBIX_CSR_NBI_STAT_NBI_PUSHPULL_P6A_ERR_E       BIT(24)
#define   NFP_NBIX_CSR_NBI_STAT_NBI_MSTR_PULLID_P7_ERR_E     BIT(23)
#define   NFP_NBIX_CSR_NBI_STAT_NBI_MSTR_PULLID_P6_ERR_E     BIT(22)
#define   NFP_NBIX_CSR_NBI_STAT_NBI_TGT_CMD_P7_ERR_E         BIT(21)
#define   NFP_NBIX_CSR_NBI_STAT_NBI_TGT_CMD_P6_ERR_E         BIT(20)
...
#define   NFP_NBIX_CSR_NBI_STAT_NBI_PM_PKT_ERR_E             BIT(11)
#define   NFP_NBIX_CSR_NBI_STAT_NBI_PM_MODSCR_DECODE_ERR_E   BIT(10)
#define   NFP_NBIX_CSR_NBI_STAT_CPP_DATA_OUT_ERR             BIT(9)
#define   NFP_NBIX_CSR_NBI_STAT_CPP_DATA_IN_ERR              BIT(8)
...
#define   NFP_NBIX_CSR_NBI_CTRL_CPP_TARGET_CPP_TX_ERR_ENA    BIT(5)
#define   NFP_NBIX_CSR_NBI_CTRL_CPP_TARGET_CPP_RX_ERR_ENA    BIT(4)
#define   NFP_NBIX_CSR_NBI_CTRL_ING_DMA_CPP_TX_ERR_ENA       BIT(3)
#define   NFP_NBIX_CSR_NBI_CTRL_ING_DMA_CPP_RX_ERR_ENA       BIT(2)
#define   NFP_NBIX_CSR_NBI_CTRL_EGR_DMA_CPP_TX_ERR_ENA       BIT(1)
#define   NFP_NBIX_CSR_NBI_CTRL_EGR_DMA_CPP_RX_ERR_ENA       BIT(0)
/*----------------------------------------------------------------
...
#define   NFP_NBIX_CSR_NBI_XPB_TOSTAT_TO_ERROR               BIT(16)
...
#define   NFP_NBIX_CSR_NBI_MACRD256_XPB_TOSTAT_TO_ERROR      BIT(16)
...
#define   NFP_NBIX_CSR_NbiStat_NbiXpbMstrTimeOutE            BIT(28)
#define   NFP_NBIX_CSR_NbiStat_NbiPushPullP7BE               BIT(27)
#define   NFP_NBIX_CSR_NbiStat_NbiPushPullP7AE               BIT(26)
#define   NFP_NBIX_CSR_NbiStat_NbiPushPullP6BE               BIT(25)
#define   NFP_NBIX_CSR_NbiStat_NbiPushPullP6AE               BIT(24)
#define   NFP_NBIX_CSR_NbiStat_NbiMstrPullidP7E              BIT(23)
#define   NFP_NBIX_CSR_NbiStat_NbiMstrPullidP6E              BIT(22)
#define   NFP_NBIX_CSR_NbiStat_NbiTgtCmdP7E                  BIT(21)
#define   NFP_NBIX_CSR_NbiStat_NbiTgtCmdP6E                  BIT(20)
...
#define   NFP_NBIX_CSR_NbiStat_NbiPmPktErrE                  BIT(11)
#define   NFP_NBIX_CSR_NbiStat_NbiPmModscrDecodeErrE         BIT(10)
#define   NFP_NBIX_CSR_NbiStat_CppDataOutErr                 BIT(9)
#define   NFP_NBIX_CSR_NbiStat_CppDataInErr                  BIT(8)
...
#define   NFP_NBIX_CSR_NbiCtrl_CppTargetCppTxErrEna          BIT(5)
#define   NFP_NBIX_CSR_NbiCtrl_CppTargetCppRxErrEna          BIT(4)
#define   NFP_NBIX_CSR_NbiCtrl_IngDmaCppTxErrEna             BIT(3)
#define   NFP_NBIX_CSR_NbiCtrl_IngDmaCppRxErrEna             BIT(2)
#define   NFP_NBIX_CSR_NbiCtrl_EgrDmaCppTxErrEna             BIT(1)
#define   NFP_NBIX_CSR_NbiCtrl_EgrDmaCppRxErrEna             BIT(0)
/*----------------------------------------------------------------
  Register: NbiXpbMaxTo - XPB Maximum Timeout Limit
    Bits: 14:0  XpbMaxTimeoutCnt(rw) - Configures the allowed maximum number of clock cycles for an XPB target to respond in before a timeout is declared.
*/
...
#define   NFP_NBIX_CSR_NbiXpbToStat_TimeOutError             BIT(16)
...
#define   NFP_NBIX_CSR_NbiMacRd256XpbToStat_TimeOutError     BIT(16)
