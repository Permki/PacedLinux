...
#define   NFP_IMB_TGTADDRESSMODECFG_ADDRESSING_MODE          BIT(12)
#define     NFP_IMB_TGTADDRESSMODECFG_ADDRESSING_MODE_32_BIT (0 << 12)
#define     NFP_IMB_TGTADDRESSMODECFG_ADDRESSING_MODE_40_BIT BIT(12)
...
#define   NFP_IMB_ISLAND_CONFIGURATION_CLASS_A_NN_CHAIN_CONFIG BIT(31)
#define     NFP_IMB_ISLAND_CONFIGURATION_CLASS_A_NN_CHAIN_CONFIG_CHAIN_A (0 << 31)
#define     NFP_IMB_ISLAND_CONFIGURATION_CLASS_A_NN_CHAIN_CONFIG_CHAIN_B BIT(31)
#define   NFP_IMB_ISLAND_CONFIGURATION_CLASS_A_BROADCAST_MODE BIT(30)
...
#define   NFP_IMB_IslandConfigurationClassA_NNchainCfg       BIT(31)
#define     NFP_IMB_IslandConfigurationClassA_NNchainCfg_Chain_A (0 << 31)
#define     NFP_IMB_IslandConfigurationClassA_NNchainCfg_Chain_B BIT(31)
#define   NFP_IMB_IslandConfigurationClassA_BroadcastMode    BIT(30)
