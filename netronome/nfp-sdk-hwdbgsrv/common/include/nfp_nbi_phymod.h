...
/**
 * Retrieve ascii vendor name and/or vendor IEEE id(OUI)
 * @ingroup nfp6000-only
 *
 * @param phymod PHY module
 * @param name[out]  location to copy name string to.
 * @param size[in]   size of memory pointed to by name
 * @param oui[out]   location to store 24 bit OUI value
 *
 ...
 *
 */
int nfp_phymod_read_product(struct nfp_phymod *phymod, char *product,
                                 uint32_t size);
