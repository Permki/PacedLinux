...
/**
 * Enable/disable out-of-band flow control for Traffic Manager queues 0-511
 */
    int oobfc_0_511_ena;
/**
 * Enable/disable out-of-band flow control for Traffic Manager queues 511-1023
 */
 ...
 */
    int pause_thresh[8];
/**
 * Watermark at which pause frames (XOFF) will be sent for all channels on the port
 */
    int highwater_mark;
/**
 * Exceeding the high watermark plus this drop delta will result in packet drops
 */
    int drop_delta;
/**
 ...
 */
    int frame_length;
/**
 * DWRR weight assigned to the port for dequeuing packets through the NBI.
 */
    int ig_dq_dwrr_weight;
/**
 * Enable/disable round robin dequeuing of this port's channels on egress
 */
    int egress_port_rr;
/**
 * Enable/disable checking of payload length against the frame's Length/Type field
 */
    int length_check;
/**
 * Enable/disable forwarding of the CRC field of received frames to the application.
 */
    int crc_fwd;
/**
 * Enable/disable forwarding of received pause frames to the application.
 */
    int pause_fwd;
/**
 ...
 */
    int channel_base;
/**
 * Number of channels assigned to the port - max 64 in memory split mode, 128 in un-split mode
 *
 */
    int num_channels;
/**
 ...
 *
 * This function initializes a MAC configuration structure by reading
 * default values from the NFP Ethernet configuration registers for a single port.
 *
 *
 *  @param nbi NBI handle
 ...
 */
NFP_NBI_API
int nfp_nbi_mac_ilk_dump_rx_config(FILE *fp, struct
                                   nfp_nbi_mac_ilk_rx_config *rxcfg,
                                   int core);
