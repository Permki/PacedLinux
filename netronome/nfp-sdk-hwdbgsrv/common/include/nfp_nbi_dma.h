 ...
 * Configurations paramters for nfp nbi dma functional aspects ctm
...
struct nfp_nbi_dma_blq_event_config {
    ...
    /** BLQ Threshold 0,1,2,3 to generate event when 16,32,64,128 buffers are read*/
 ...
 */
NFP_NBI_API
int nfp_nbi_dma_cfg_blq_event(struct nfp_nbi_dev *nfpnbi, struct nfp_nbi_dma_blq_event_config
                                 *blqevnt_cfg);
/**
 *  Enable/Diable NFP NBI DMA Buffer List Queue Event FIFO full assert
 * @ingroup nfp6000-only
 *
 ...
 */
NFP_NBI_API
int nfp_nbi_dma_read_bp(struct nfp_nbi_dev *nfpnbi, int bp,
 ...
 */
NFP_NBI_API
int nfp_nbi_dma_read_bpe(struct nfp_nbi_dev *nfpnbi, int bpe,
 ...
 */
NFP_NBI_API
int nfp_nbi_dma_read_blq(struct nfp_nbi_dev *nfpnbi, int blq,
 ...
 */
NFP_NBI_API
int nfp_nbi_dma_read_blq_event(struct nfp_nbi_dev *nfpnbi, int blq,
 ...
 */
NFP_NBI_API
int nfp_nbi_dma_read_blq_status(struct nfp_nbi_dev *nfpnbi, int blq,
